...
// get recommended user controller
const getRecommendedUsers = async (req, res) => {
  try {
    ...
    console.log("error in get recommended users controller", error);
    res.status(500).json({
      success: false,
...
const sendFriendRequest = async (req, res) => {
  try {
    ...
    // check if a req 4 already exists
...
// get freind requests in notification area controller
const getFriendRequests = async (req, res) => {
  try {
    ...
    console.log("error in get friend request controller", error);
    res.status(500).json({
      success: false,
      message: error.message,
    });
...
// get out going friend requests controller
const getOutgoingFriendRequests = async (req, res) => {
  try {
    ...
    console.log("error in get outgoing friend request controller", error);
    res.status(500).json({
      success: false,
      message: error.message,
    });
